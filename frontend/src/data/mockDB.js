...
const initDB = () => {
  if (!localStorage.getItem('rurai_db_usuarios')) {
    localStorage.setItem('rurai_db_usuarios', JSON.stringify(initialData.usuarios));
  }
  if (!localStorage.getItem('rurai_db_actividades')) {
    localStorage.setItem('rurai_db_actividades', JSON.stringify(initialData.actividades));
  }
  if (!localStorage.getItem('rurai_db_temas')) {
    localStorage.setItem('rurai_db_temas', JSON.stringify(initialData.temas));
  }
};
...
export const mockDB = {
  getUsuarios: () => JSON.parse(localStorage.getItem('rurai_db_usuarios') || '[]'),
  saveUsuarios: (usuarios) => localStorage.setItem('rurai_db_usuarios', JSON.stringify(usuarios)),
  
  getActividades: () => JSON.parse(localStorage.getItem('rurai_db_actividades') || '[]'),
  saveActividades: (actividades) => localStorage.setItem('rurai_db_actividades', JSON.stringify(actividades)),
  
  getTemas: () => JSON.parse(localStorage.getItem('rurai_db_temas') || '[]'),
};
